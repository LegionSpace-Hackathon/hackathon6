...
public class RSAUtil {
    ...
    public static String decryptByPublicKey(String base64, String publicKey) throws Exception {
        byte[] bytes = decryptByPublicKey(Base64Utils.decode(base64), publicKey);
